...
public class LecturerService {
    ...
    public Page<LecturerVo> search(ReqLecturerSearchVo searchVo, Pageable pageable) throws Exception {
        Page<LecturerEntity> adminEntityPage = qLecturerRepository.findList(searchVo, pageable);
        return new PageImpl<>(lecturerMapper.toVos(adminEntityPage.getContent()), pageable, adminEntityPage.getTotalElements());
    }
